...
let NSUnderlinePatternSolid: NSUnderlineStyle
@available(*, unavailable, message: "Not available in Swift")
let NSUnderlinePatternDot: NSUnderlineStyle
@available(*, unavailable, message: "Not available in Swift")
let NSUnderlinePatternDash: NSUnderlineStyle
@available(*, unavailable, message: "Not available in Swift")
let NSUnderlinePatternDashDot: NSUnderlineStyle
@available(*, unavailable, message: "Not available in Swift")
let NSUnderlinePatternDashDotDot: NSUnderlineStyle
@available(*, unavailable, message: "Not available in Swift")
let NSUnderlineByWord: NSUnderlineStyle
